...
//     1Знайти суму та кількість позитивних елементів.
//     2Знайти мінімальний елемент масиву та його порядковий номер.
//     3Знайти максимальний елемент масиву та його порядковий номер.
//     4Визначити кількість негативних елементів.
//     5Знайти кількість непарних позитивних елементів.
//     6Знайти кількість парних позитивних елементів.
//     7Знайти суму парних позитивних елементів.
//     8Знайти суму непарних позитивних елементів.
//     9Знайти добуток позитивних елементів.
//     0Знайти найбільший серед елементів масиву, ост альні обнулити.
